...
curl -OJL https://go.dev/dl/go1.18.2.linux-amd64.tar.gz #安装go环境，如不希望可以注释掉
sudo tar -C /usr/local -xzf go1.18.2.linux-amd64.tar.gz ; rm go1.18.2.linux-amd64.tar.gz
